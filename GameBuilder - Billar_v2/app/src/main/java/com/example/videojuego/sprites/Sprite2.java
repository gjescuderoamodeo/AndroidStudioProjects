...
public abstract class Sprite2 {
     ...
     public Sprite2(int screenX, int screenY){
     ...
     public Sprite2(int screenX, int screenY, int x, int y){
          mScreenX=screenX;
          mScreenY=screenY;
          color=Color.argb(255, 255, 255, 255);
          paint=new Paint();
     ...
     public abstract boolean colision(Sprite2 s);
     ...
     public void onColisionEvent(Sprite2 sprite2) {
     }
}
